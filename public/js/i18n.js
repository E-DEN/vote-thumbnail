...
registerLang('ja', '日本語', {
  ...
  'react-you': 'あなた',
  'react-max-pins': 'ピン数',
  'react-dummy-toggle': 'ピン見本',
  'react-dummy-toggle-title': 'ピンが少ない場合、表示確認用のサンプルピンを補完します',
  'react-pin-color': 'ピン色',
  ...
  'preset-load': '読込',
  'preset-share': 'コード共有',
  'share-link-copy-title': '共有リンクをコピー',
  'share-link-copied': '共有リンクをコピーしました',
  'share-link-err': '共有リンクの生成に失敗しました',
  'share-link-import-confirm': '{count}件のチャンネルを追加します。よろしいですか？',
  'share-link-not-found': '共有リンクが見つかりませんか、期限切れの可能性があります',
  'm-ch-share': '共有リンク',
  'folder-share': '共有リンク',
...
registerLang('en', 'English', {
  ...
  'react-dummy-toggle': 'Sample Pins',
  'react-dummy-toggle-title': 'Shows sample pins when there are few real reactions',
  ...
  'share-link-copy-title': 'Copy share link',
  'share-link-copied': 'Share link copied',
  'share-link-err': 'Failed to generate share link',
  'share-link-import-confirm': 'Add {count} channel(s) from this share link?',
  'share-link-not-found': 'Share link not found or expired',
  'm-ch-share': 'Share Link',
  'folder-share': 'Share Link',
