...
registerLang('ja', '日本語', {
  ...
  'error-msg':                  'エラー: {msg}',
  'fetching':          '取得中...',
  'refresh-btn-title': '再取得',
  'delete-btn-title':  '削除',
  'new-folder':        'フォルダ',
  'cancel':            'キャンセル',
  'folder-dialog-title':  '新規フォルダ',
  ...
  'reactions-you':     'あなた',
  'reactions-max-pins': 'ピン数',
  'reactions-pin-color':   'ピン色',
  'reactions-pin-opacity': 'ピン透過度',
  ...
  'sort-random': 'ランダム',
  // モバイル画面
  'vote-show-title': 'タイトルを表示',
  'open-youtube':    'YouTubeで開く',
  'copy-url':        'URLをコピー',
  ...
  'back-btn':        '戻る',
  'no-description':  'この動画には説明が追加されていません。',
  'date-year-fmt':   '{y}年',
  'date-md-fmt':     '{m}月{d}日',
  // 表示フォーマット
  'views-100m': '{n}億回視聴',
  ...
  'ch-added':                '{name} を追加しました',
  'ch-refreshing':           '{name} を更新中...',
  'import-done':             '{count} 件取得完了',
...
registerLang('en', 'English', {
  ...
  'select-channel-prompt': 'Select a channel',
  'no-channels-registered': 'No channels registered. Add one below.',
  'ch-add-placeholder': '@handle or URL',
  'add-aria':          'Add',
  ...
  'delete-btn-title':  'Delete',
  'new-folder':        'Folder',
  'cancel':            'Cancel',
  'folder-dialog-title':  'New Folder',
  ...
  'reactions-you':     'You',
  'reactions-max-pins': 'Pin Count',
  'reactions-pin-color':   'Pin Color',
  'reactions-pin-opacity': 'Pin Opacity',
  ...
  'folder-color-title':          'Folder color',
  ...
  'ch-added':                '{name} added',
  'ch-refreshing':           'Updating {name}...',
  'import-done':             '{count} videos fetched',
